...
It is not [[https://github.com/admk/sembr][admk/sembr]] (learned clause breaks) and not [[https://github.com/sembr/skills][sembr/skills]] (agent rewrite instructions).
...
snapper mcp
#+end_src
Agents should call snapper MCP (=format_text=) or the =snapper= CLI instead of applying [[https://sembr.org/][sembr.org]] / [[https://github.com/sembr/skills][sembr/skills]] wrapping by hand.
