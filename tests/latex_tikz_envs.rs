//! snapper-e916 / GitHub #97: tikzcd, axis, and pgfpicture are Structure.
...
#[test]
fn axis_pgfpicture_and_starred_do_not_reflow() {
    for name in ["axis", "axis*", "pgfpicture", "pgfpicture*", "tikzcd*"] {
        let input = format!(
