//! GitHub #178 / snapper-57v0: Org dynamic-block body stays Structure.
...
fn clocktable_dynamic_block_fixture() -> &'static str {
    concat!(
...
fn dynamic_block_body_stays_frozen_following_prose_splits() {
    let input = clocktable_dynamic_block_fixture();
    ...
    assert_eq!(
        ...
        "BEGIN: through END: must stay frozen; following prose splits, got:\n{out}"
    );
