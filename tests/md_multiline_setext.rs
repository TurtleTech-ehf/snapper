...
/// snapper-0u23: `<!-- toc -->` then setext must not duplicate the comment.
#[test]
fn setext_after_html_comment_comment_appears_once() {
    let input = concat!(
        "<!-- toc -->\n",
        "My Title\n",
        "========\n",
...
/// snapper-0u23: indented code then setext must not copy the code line
/// into Structure.
#[test]
fn setext_after_indented_code_code_appears_once() {
    let input = concat!(
        "    code line\n",
        "Heading here\n",
        "=======\n",
