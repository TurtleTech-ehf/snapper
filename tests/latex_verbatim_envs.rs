...
#[test]
fn tools_verbatiminput_fixture_does_not_join_following_prose() {
    let input = concat!(
        "Before. Next.\n",
        "\\verbatiminput{foo.py}\n",
        "After. Next.\n",
...
/// listinginput / inputpy / tcbinputlisting / PitonInputFile unchanged.
#[test]
...
/// one atomic command. Following flush `After.` does not join the
/// command line. `After.` / `Next.` still split. scontents /
/// verbatimsc / inputpy / sageinput / listinginput unchanged.
#[test]
