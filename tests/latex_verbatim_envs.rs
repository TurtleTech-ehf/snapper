...
//! command; following flush prose stays on its own line.
...
/// `After.` does not join the command line. Optional `[...]` stays
/// atomic. pycode / pyconsole / inputminted / lstinputlisting /
