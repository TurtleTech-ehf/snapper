...
//! `>>>( +|$)`. Lone `>>>` at EOL is Structure; following prose still
//! splits. Same-line `>>> print(1.2)` still opens a doctest block.
...
#[test]
fn empty_doctest_opener_is_structure() {
...
#[test]
fn ticket_fixture_keeps_empty_opener_and_splits_next() {
...
#[test]
fn trailing_space_empty_opener_is_structure() {
    let input = wrapped(">>> ");
