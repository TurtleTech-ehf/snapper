...
fn leftover_constructors_do_not_join() {
    ...
    leftover_cmd_stays_atomic(r"\lstlistlistingname");
    leftover_cmd_stays_atomic(r"\lstlistingnamestyle");
    leftover_cmd_stays_atomic(r"\tcbsetmacrotowidthofnode{\wd}{mynode}");
    leftover_cmd_stays_atomic(r"\tcbsettoheightofnode{\ht}{mynode}");
    leftover_cmd_stays_atomic(r"\tcbhypernode{mynode}");
    leftover_cmd_stays_atomic(r"\tcbline*");
    leftover_cmd_stays_atomic(r"\tcbmaketheorem{theo}{Theorem}{colback=red}{tcbtheo}{th}");
    leftover_cmd_stays_atomic(r"\tcbverbatimwrite{foo.tex}");
    leftover_cmd_stays_atomic(r"\tcbwritetemp");
    leftover_cmd_stays_atomic(r"\endtcbverbatimwrite");
    leftover_cmd_stays_atomic(r"\tcbrecord{foo}");
    leftover_cmd_stays_atomic(r"\tcbbreak");
    leftover_cmd_stays_atomic(r"\Depythontex{cmd:foo:m:n}");
    leftover_cmd_stays_atomic(r"\DepyMacro{p:foo}");
    ...
    leftover_cmd_stays_atomic(r"\tcbmakedocSubKey{docFooKey}{foo}");
    leftover_cmd_stays_atomic(r"\tcbmakedocSubKeys[colback=red]{docFooKeys}{foo}");
    leftover_cmd_stays_atomic(r"\refCom{tcbset}");
    leftover_cmd_stays_atomic(r"\refCom*{tcbset}");
    leftover_cmd_stays_atomic(r"\refEnv{docCommand}");
    leftover_cmd_stays_atomic(r"\refKey{/tcb/colback}");
    leftover_cmd_stays_atomic(r"\refPathOperation{lineto}");
    leftover_cmd_stays_atomic(r"\refAux{foo}");
    leftover_cmd_stays_atomic(r"\refAuxcs{foo}");
    leftover_cmd_stays_atomic(r"\refPkg{tcolorbox}");
    leftover_cmd_stays_atomic(r"\docAuxCommand{foo}");
    leftover_cmd_stays_atomic(r"\docAuxEnvironment{foo}");
    leftover_cmd_stays_atomic(r"\docAuxKey{colback}");
    leftover_cmd_stays_atomic(r"\docAuxKey[tcb]{colback}");
    leftover_cmd_stays_atomic(r"\docKeyChoices{red,blue}");
    leftover_cmd_stays_atomic(r"\docCounter{tcbcounter}");
    ...
    extras_skip_no_brace("tcbmakedocSubKey");
