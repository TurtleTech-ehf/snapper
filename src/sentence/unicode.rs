...
/// leftover. `\inputpygments` is not a span (`inputpy` + alphabetic
/// leftover). `\listinginput` (moreverb leftover; GitHub
...
mod tests {
    ...
    fn latex_inputpylab_inputsympy_stays_atomic() {
        ...
        for name in ["inputpylab", "inputpylabcon", "inputsympy", "inputsympycon"] {
            ...
            assert_eq!(
                latex_verb_span_end_with(&format!("\\{name} foo.py"), 0, &extras),
                None,
