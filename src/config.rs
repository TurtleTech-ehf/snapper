...
pub struct FormatOverrides {
    ...
    /// Meaningful under `[latex]` only. Missing or empty keeps
    /// verb/lstinline/lstinputlisting/spverb/mintinline/inputminted/mint/Verb/SaveVerb/VerbatimInput/piton/verbatiminput/PitonInputFile/tcbinputlisting/inputpy/inputpycon/listinginput/sageinput.
