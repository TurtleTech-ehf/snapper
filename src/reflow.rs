...
fn hanging_indent_width(s: &str) -> usize {
    ...
    if crate::parser::org::org_caption_opener_len(s) == Some(s.len()) {
        return s.chars().count();
    }
...
"
    ...
    fn hanging_indent_width_markers_only() {
        ...
        assert_eq!(hanging_indent_width("#+CAPTION[Short. Title.]: "), 26);
    ...
    #[test]
    fn org_caption_value_hangs_second_sentence() {
        let result = reflow_regions(vec![
