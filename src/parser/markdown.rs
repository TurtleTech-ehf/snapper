...
mod tests {
    ...
    fn quoted_setext_end_sibling_opener_is_not_title() {
        ...
        let para_lines: Vec<Line<'_>> = iter_lines(quoted_para).collect();
        ...
        let sib_lines: Vec<Line<'_>> = iter_lines(sibling).collect();
        ...
        let bullet_lines: Vec<Line<'_>> = iter_lines(bullet_then_ol).collect();
        ...
        let look_lines: Vec<Line<'_>> = iter_lines(lookback).collect();
