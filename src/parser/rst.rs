...
fn parse_line_based(input: &str) -> Vec<SpannedRegion> {
    ...
    while i < total {
        ...
        // old freeze (GitHub #54 / #351). A flush paragraph after a
...
/// body.py names (epigraph / highlights / pull-quote / compound):
/// bodies nested-parse, so hang + reflow. Option fields stay Structure
/// via the field-list arm. Other directive names stay opaque.
/// GitHub #351.
