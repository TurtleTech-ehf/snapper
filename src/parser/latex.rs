...
/// bodies; same raw grab as landed `python`; GitHub #346),
...
\end{document}";
    ...
    /// Ticket fixture (GitHub #346): pyluatex.sty `pythonq` /
    /// `pythonrepl` are verbatim Python / REPL bodies. Body stays Code
    /// and one source line; following prose still splits. Landed
    /// `python` stays Code.
    #[test]
    fn pyluatex_pythonq_pythonrepl_are_code_not_prose() {
        use crate::format_text;
