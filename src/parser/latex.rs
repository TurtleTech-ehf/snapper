...
\end{document}";
    ...
    /// the same raw grab class as landed `luacode`. Body stays Code and
    /// one source line; following prose still splits. `luacode` /
    /// `luacode*` unchanged. Distinct from `mplibcode`.
    #[test]
