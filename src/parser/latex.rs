...
\end{document}";
    ...
    /// `sageexample` / `sagecommandline` use `verbatim@start` like
    /// tree-sitter `sagesilent` / `sageblock`. Body stays Code;
    /// following prose still splits. Landed sage trivia stays Code.
    #[test]
