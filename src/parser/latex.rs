...
/// Leftover pythontex.sty `\inputpy` / `\inputpycon` / `\inputpylab` /
/// `\inputpylabcon` / `\inputsympy` / `\inputsympycon` (optional
/// `[...]`, required `{file}`; GitHub #419 / #433). One leftover
/// walker for the default-family file-input names. Longer names first
...
\end{document}";
    ...
    /// split. inputpy / listinginput / sageinput unchanged.
    #[test]
