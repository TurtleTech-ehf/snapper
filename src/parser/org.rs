...
mod tests {
    ...
    #[test]
    fn quote_inner_prose_is_not_structure() {
    ...
    #[test]
    fn quote_nested_src_closes_only_src() {
        use crate::format_text;
    ...
    #[test]
    fn verse_inner_prose_preserves_lines() {
        use crate::format_text;
