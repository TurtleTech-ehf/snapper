...
pub struct FormatConfig {
    ...
    /// and pythontex pycode/pyblock/pyverbatim/pyconsole/pygments/
    /// pylabcode/pylabcode*/pylabblock/pylabblock*/pylabverbatim/
    /// pylabverbatim*/pylabconsole/pylabconsole*. Empty keeps
    /// the built-in list.
