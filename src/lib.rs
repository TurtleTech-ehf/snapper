...
pub struct FormatConfig {
    ...
    /// Empty keeps verb/lstinline/lstinputlisting/spverb/mintinline/inputminted/mint/Verb/SaveVerb/VerbatimInput/piton/verbatiminput/PitonInputFile/tcbinputlisting/inputpy/inputpycon.
