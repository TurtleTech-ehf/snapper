...
//! - **RST**: directives and literals preserved; admonition/figure/topic/sidebar/container/epigraph/highlights/pull-quote/compound bodies reflow; `.. code-block::` is a code region
