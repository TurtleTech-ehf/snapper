...
//! - **RST**: directives and literals preserved; admonition/figure/topic/sidebar/container/parsed-literal/epigraph/highlights/pull-quote/compound/header/footer bodies reflow; `.. code-block::` is a code region
...
pub struct FormatConfig {
    ...
    /// Empty keeps verb/lstinline/lstinputlisting/spverb/mintinline/inputminted/mint/Verb/SaveVerb/VerbatimInput/piton/verbatiminput/PitonInputFile/PitonInputFileT/PitonInputFileF/PitonInputFileTF/tcbinputlisting/inputpy/inputpycon/py/pyc/pys/pyb/pyv/pycon and twins/sympy/pylab and twins/usefamily ruby/rb/julia/jl/matlab/octave/bash/sage/rust/rs/R/perl/pl/perlsix/psix/javascript/js and .
