...
Structural elements such as equations and figures pass through unchanged.
Code listings (\texttt{minted}/\texttt{lstlisting}) are code regions: non-comment lines stay fixed while configured comments reflow.
