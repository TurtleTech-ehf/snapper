...
- =--use-pandoc= lifts those spans, writes them back as raw blocks, and exits 0 with the text still present.
- Native parsers stay the default until the product flip.
