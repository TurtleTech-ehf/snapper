...
leftover =\UseVerb= / =\UseVerb*= take optional =[...]= then a required ={name}=; leftover =\UseVerbatim= / =\LUseVerbatim= / =\BUseVerbatim= take optional =[...]= then a required ={name}=; following flush prose stays on its own line.
leftover =\Verb= / =\Verb*= take a delimiter; leftover =\EscVerb= takes optional =[...]= then a delimiter or ={code}= body; following flush prose stays on its own line.
