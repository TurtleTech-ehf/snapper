...
Built-in names are =verb=, =lstinline=, =spverb=, =mintinline=, and =mint=; =lstinline= still accepts optional =[...]= and ={...}=. =mintinline= / =mint= take optional =[...]=, a ={lang}= argument, then a delimiter or ={...}= body.
