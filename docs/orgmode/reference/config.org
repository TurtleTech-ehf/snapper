...
=\py= / =\pyc= / =\pys= / =\pyb= / =\pyv= / =\pycon= / =\sympy= / =\pylab= and twins take optional =[...]= then a delimiter or ={body}=; following flush prose stays on its own line.
