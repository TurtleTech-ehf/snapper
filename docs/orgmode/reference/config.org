...
leftover fvextra =VerbatimInsertBuffer= / =VerbatimClearBuffer= / =InsertBuffer= take optional =[...]=; leftover =IterateBuffer= takes optional =[...]= then a required ={cmd}=; following flush prose stays on its own line.
