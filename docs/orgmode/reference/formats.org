...
:END:
- Non-source =#+BEGIN_*= ...
=#+END_*= fences, and literal bodies (example, export, comment, unknown names)
- =:PROPERTIES:= ...
=:END:= drawers
...
:END:
- Paragraph text
- Quote, verse, and center block interiors (open/close lines stay structure; verse keeps physical lines)
