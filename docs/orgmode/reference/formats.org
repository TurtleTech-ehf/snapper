...
- pythontex.sty =pyblock= / =pyverbatim= / =pyconsole= / =pygments= / =pylabcode= / =pylabcode*= / =pylabblock= / =pylabblock*= / =pylabverbatim= / =pylabverbatim*= / =pylabconsole= / =pylabconsole*= are the same =VerbatimEnvironment= class as =pycode=
