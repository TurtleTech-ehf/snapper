...
- Non-prose environments: equation, align, alignat, xalignat, xxalignat, array, subarray, CD, prooftree, matrix, smallmatrix, tabular, tikzpicture, and their starred variants (plus other non-code envs)
