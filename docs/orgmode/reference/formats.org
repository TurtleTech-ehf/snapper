...
- Non-prose environments: equation, align, alignat, xalignat, xxalignat, empheq, cases, numcases, array, subarray, CD, prooftree, matrix, smallmatrix, tabular, tikzpicture, and their starred variants (plus other non-code envs).
