...
- pythontex.sty =pyblock= / =pyverbatim= / =pyconsole= / =pygments= / =pylabcode= / =pylabblock= / =pylabverbatim= / =pylabconsole= and starred twins are the same =VerbatimEnvironment= class as =pycode=
