...
- Non-prose environments: equation, align, alignat, xalignat, xxalignat, matrix, smallmatrix, tabular, tikzpicture, and their starred variants (plus other non-code envs)
