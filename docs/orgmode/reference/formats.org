...
- Inline =\verb= / =\lstinline= / =\spverb= / =\mintinline= / =\mint= / fancyvrb =\Verb= / =\Verb*= / =\SaveVerb= / =\VerbatimInput= / =\BVerbatimInput= / =\LVerbatimInput= / piton.sty =\piton= / =\PitonInputFile= / =\PitonInputFileT= / =\PitonInputFileF= / =\PitonInputFileTF= / listings.sty =\lstinputlisting= / minted.sty =\inputminted= / tools/verbatim.sty =\verbatiminput= / tcolorbox =\tcbinputlisting= / pythontex.sty =\inputpy= / =\inputpycon= / =\inputpygments= / =\pygment= / =\py= / =\pyc= / =\pys= / =\pyb= / =\pyv= / =\pycon= / =\sympy= / =\pylab= and twins / catchfilebetweentags.sty =\CatchFileBetweenTags= / =\CatchFileBetweenDelims= / =\ExecuteMetaData= / moreverb =\listinginput= / sagetex =\sageinput= / scontents =\inputsc= (and extra =[latex].verbatim_commands=) stay atomic; inner =.!?%= do not split or comment.
  ...
  =\py= / =\pyc= / =\pys= / =\pyb= / =\pyv= / =\pycon= / =\sympy= / =\pylab= and twins take optional =[...]= then a delimiter or ={body}=; a flush following sentence stays on its own line
