...
- Display math (=\[= ... =\]=)
- Line breaks (=\\= at end of line, org-element-line-break-parser); the next physical line stays its own sentence
...
- Setext headings (one or more title lines plus ====== or ------ underline, including list/quote items, hard-break title lines, and a 4-space =<!--= continuation)
- List item markers (=-=, =*=, =+=, =1.=); continuation sentences hang at the marker width
