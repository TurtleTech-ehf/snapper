...
- Container directive openers (=.. note::=, =.. warning::=, =.. figure::=, =.. topic::=, =.. sidebar::=, =.. container::=, leftover =.. epigraph::= / =.. highlights::= / =.. pull-quote::= / =.. compound::=) and their =:option:= fields; the indented body is prose
...
- Indented bodies of container directives (admonitions, figure captions, topic, sidebar, container, leftover epigraph / highlights / pull-quote / compound); hang spaces stay structure
