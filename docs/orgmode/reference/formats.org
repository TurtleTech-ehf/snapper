...
- pythontex.sty =pyblock= / =pyverbatim= / =pyconsole= / =pygments= / =sympycode= / =sympyblock= / =sympyverbatim= / =sympyconsole= and starred twins are the same =VerbatimEnvironment= class as =pycode=
