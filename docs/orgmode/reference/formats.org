...
- leftover listings.sty =\lstinputlisting= / =\lstinputlisting*= take optional =[...]= then a ={filename}=
  The command stays one token; a flush following sentence stays on its own line
