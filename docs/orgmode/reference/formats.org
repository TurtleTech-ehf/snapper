...
:END:
- Substitution references: =|fig. 1|= / =|name|_= / =|name|__= (Docutils Inliner.substitution_ref). Interior punctuation is not a sentence or wrap boundary. The use stays Prose, not Structure (line-block is =|= plus space or EOL)
